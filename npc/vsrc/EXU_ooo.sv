...
wire [31:0] rs1_data = data_i.rs1_data;  // 来自物理寄存器堆
...
always_comb begin
    unique case (data_i.ex.alu_src)
        ALU_SRC_RS1_RS2: begin alu_src1 = rs1_data; alu_src2 = rs2_data; end
        ALU_SRC_RS1_IMM: begin alu_src1 = rs1_data; alu_src2 = imm;      end
        ALU_SRC_PC_4:    begin alu_src1 = pc;       alu_src2 = 32'h4;    end
        ALU_SRC_PC_IMM:  begin alu_src1 = pc;       alu_src2 = imm;      end
    endcase
end
