...
// DUT 信号
logic [5:0]  read_addr1_i;
logic [5:0]  read_addr2_i;
logic [31:0] read_data1_o;
logic [31:0] read_data2_o;
logic        write_en1_i;
logic        write_en2_i;
logic [5:0]  write_addr1_i;
logic [5:0]  write_addr2_i;
logic [31:0] write_data1_i;
logic [31:0] write_data2_i;
...
initial begin
    ...
    write_en1_i   = 1;
    write_addr1_i = 6'd33;
    write_data1_i = 32'h1111_1111;
    write_en2_i   = 1;
    write_addr2_i = 6'd34;
    write_data2_i = 32'h2222_2222;
    tick;
    write_en1_i  = 0;
    write_en2_i  = 0;
    read_addr1_i = 6'd33;
    ...
    write_en1_i   = 1;
    write_addr1_i = 6'd35;
    write_data1_i = 32'hAAAA_AAAA;
    write_en2_i   = 1;
    write_addr2_i = 6'd35;
    write_data2_i = 32'hBBBB_BBBB;
    tick;
    write_en1_i = 0;
    write_en2_i = 0;
    read_addr1_i = 6'd35;
    ...
    read_addr2_i = 6'd31;
    tick;
    chk32("p1 复位后为0", 32'h0, read_data1_o);
    chk32("p31 复位后为0", 32'h0, read_data2_o);

    // ── 测试6：高地址寄存器（p63） ──
    $display("\n[TEST6] 最高地址 p63");
    write_en2_i   = 1;
    write_addr2_i = 6'd63;
    write_data2_i = 32'hFFFF_FFFF;
    tick;
    write_en2_i = 0;
    read_addr2_i = 6'd63;
    tick;
