...
assign dispatch_pkt_o.exception       = decode_pkt_i.exception;
assign dispatch_pkt_o.exception_cause = decode_pkt_i.exception_cause;
...
assign rob_alloc_pkt_o.exception   = decode_pkt_i.exception;
assign rob_alloc_pkt_o.exception_cause = decode_pkt_i.exception_cause;
